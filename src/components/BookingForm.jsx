        ...
        <div className={`glass-dark p-5 sm:p-10 rounded-3xl border border-slate-700/80 shadow-2xl relative ${isModal ? 'bg-slate-900 text-white' : ''}`}>
          ...
          {submitted ? (
            ...
            <div className="text-center py-8 space-y-6 animate-in zoom-in-95 duration-500">
              <div className="w-16 h-16 sm:w-20 sm:h-20 bg-emerald-500 text-white rounded-full flex items-center justify-center mx-auto shadow-2xl shadow-emerald-500/40">
              ...
              <div className="bg-slate-800/90 p-4 sm:p-5 rounded-2xl border border-slate-700 text-left max-w-md mx-auto space-y-3 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-amber-300">+91 99491 87262</span>
                </div>
              </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 sm:pl-12 sm:pr-4 py-3 rounded-xl bg-slate-800/90 border border-slate-700 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-500/20 text-white text-xs sm:text-sm outline-none transition-all"
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-3 sm:pl-12 sm:pr-4 py-3 rounded-xl bg-slate-800/90 border border-slate-700 focus:border-emerald-500 text-white text-xs sm:text-sm outline-none transition-all"
                    >
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-3.5 sm:px-4 py-3 rounded-xl bg-slate-800/90 border border-slate-700 focus:border-emerald-500 text-white text-xs sm:text-sm outline-none transition-all"
                  >
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-3.5 sm:px-4 py-3 rounded-xl bg-slate-800/90 border border-slate-700 focus:border-emerald-500 text-white text-xs sm:text-sm outline-none transition-all resize-none"
                />
              </div>
